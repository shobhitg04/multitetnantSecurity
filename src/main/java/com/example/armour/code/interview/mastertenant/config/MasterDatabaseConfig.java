package com.example.armour.code.interview.mastertenant.config;
...
@EnableJpaRepositories(basePackages = {"com.example.armour.code.interview.mastertenant.entity", "com.example.armour.code.interview.mastertenant.repository"},

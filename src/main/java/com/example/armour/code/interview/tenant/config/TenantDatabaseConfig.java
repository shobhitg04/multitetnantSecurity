...
@ComponentScan(basePackages = { "com.example.armour.code.interview.tenant.repository", "com.example.armour.code.interview.tenant.entity" })
@EnableJpaRepositories(basePackages = {"com.example.armour.code.interview.tenant.repository", "com.example.armour.code.interview.tenant.service" },
...
public class TenantDatabaseConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(
        ...
        emfBean.setPackagesToScan("com.example.armour.code.interview");
